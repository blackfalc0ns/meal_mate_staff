...
void main() {
  ...
  testWidgets(
    'picker field triggers onTap cleanly without gaining text focus',
    (tester) async {
      bool tapped = false;
  ...
  group('RegistrationInputField height tests', () {
    testWidgets(
      'scenario 1: plain text field keeps 40px input container on error',
      (tester) async {
    ...
    testWidgets(
      'scenario 2: field with prefixIcon keeps 40px input container on error',
      (tester) async {
        final formKey = GlobalKey<FormState>();
        await tester.pumpWidget(
          MaterialApp(
    ...
    testWidgets(
      'scenario 3: field with picker arrow keeps 40px input container on error',
      (tester) async {
        final formKey = GlobalKey<FormState>();
        await tester.pumpWidget(
          MaterialApp(
    ...
    testWidgets(
      'scenario 4: field with suffixIcon keeps 40px input container on error',
      (tester) async {
        final formKey = GlobalKey<FormState>();
        await tester.pumpWidget(
          MaterialApp(
    ...
    testWidgets('scenario 5: field with prefix stays aligned at top on error', (
      tester,
    ) async {
      final formKey = GlobalKey<FormState>();
      await tester.pumpWidget(
