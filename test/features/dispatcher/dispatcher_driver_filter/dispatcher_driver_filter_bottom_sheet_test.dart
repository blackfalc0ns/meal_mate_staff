...
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/domain/entities/dispatcher_driver_filter_criteria_entity.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_action_buttons.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_area_section.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_bottom_sheet.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_distance_section.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_header.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_orders_section.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_rating_section.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_search_section.dart';
import 'package:meal_mate_delivery/features/dispatcher/dispatcher_driver_filter/presentation/widgets/dispatcher_driver_filter_status_section.dart';
...
void main() {
  ...
  group('DispatcherDriverFilterBottomSheet Tests', () {
    testWidgets('renders all major sections and components in RTL Arabic', (
      ...
      await tester.pumpWidget(
        _buildTestableWidget(child: const DispatcherDriverFilterBottomSheet()),
      );
      await tester.pumpAndSettle();

      expect(find.byType(DispatcherDriverFilterHeader), findsOneWidget);
    ...
    testWidgets('renders properly in English locale', (tester) async {
      ...
      await tester.pumpWidget(
        _buildTestableWidget(
          ...
          child: const DispatcherDriverFilterBottomSheet(),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('allows selecting filters and applying criteria', (
      ...
      DispatcherDriverFilterCriteriaEntity? appliedCriteria;
      ...
      expect(find.byType(DispatcherDriverFilterBottomSheet), findsOneWidget);
