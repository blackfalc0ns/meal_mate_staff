...
void main() {
  group('DriverPerformance Domain Entities Tests', () {
    test(
      'DriverPerformancePeriod matches exact API values and handles unknown',
      () {
        ...
        expect(
          DriverPerformancePeriod.fromApi('Last7Days'),
          DriverPerformancePeriod.last7Days,
        );
        expect(
          DriverPerformancePeriod.fromApi('ThisMonth'),
          DriverPerformancePeriod.thisMonth,
        );
        expect(
          DriverPerformancePeriod.fromApi('future_period'),
          DriverPerformancePeriod.unknown,
        );
        expect(
          DriverPerformancePeriod.fromApi(null),
          DriverPerformancePeriod.unknown,
        );
      },
    );
    ...
    test('DriverPerformanceDelayLevel maps values and handles unknown', () {
      expect(
        DriverPerformanceDelayLevelX.fromApi('good'),
        DriverPerformanceDelayLevel.good,
      );
      expect(
        DriverPerformanceDelayLevelX.fromApi('warning'),
        DriverPerformanceDelayLevel.warning,
      );
      expect(
        DriverPerformanceDelayLevelX.fromApi('critical'),
        DriverPerformanceDelayLevel.critical,
      );
      expect(
        DriverPerformanceDelayLevelX.fromApi('future'),
        DriverPerformanceDelayLevel.unknown,
      );
      expect(
        DriverPerformanceDelayLevelX.fromApi(null),
        DriverPerformanceDelayLevel.unknown,
      );
    });
    ...
    test('DriverPerformanceDriverStatus maps values and handles unknown', () {
      expect(
        DriverPerformanceDriverStatus.fromApi('available'),
        DriverPerformanceDriverStatus.available,
      );
      expect(
        DriverPerformanceDriverStatus.fromApi('onTheWay'),
        DriverPerformanceDriverStatus.onTheWay,
      );
      expect(
        DriverPerformanceDriverStatus.fromApi('onBreak'),
        DriverPerformanceDriverStatus.onBreak,
      );
      expect(
        DriverPerformanceDriverStatus.fromApi('unexpected'),
        DriverPerformanceDriverStatus.unknown,
      );
      expect(
        DriverPerformanceDriverStatus.fromApi(null),
        DriverPerformanceDriverStatus.unknown,
      );
    });

    test(
      'DriverPerformanceDistributionCategory maps Delayed to late and handles unknown',
      () {
        expect(
          DriverPerformanceDistributionCategory.fromApi('onTime'),
          DriverPerformanceDistributionCategory.onTime,
        );
        expect(
          DriverPerformanceDistributionCategory.fromApi('Delayed'),
          DriverPerformanceDistributionCategory.late,
        );
        expect(
          DriverPerformanceDistributionCategory.fromApi('late'),
          DriverPerformanceDistributionCategory.late,
        );
        expect(
          DriverPerformanceDistributionCategory.fromApi('failed'),
          DriverPerformanceDistributionCategory.failed,
        );
        expect(
          DriverPerformanceDistributionCategory.fromApi('cancelled'),
          DriverPerformanceDistributionCategory.cancelled,
        );
        expect(
          DriverPerformanceDistributionCategory.fromApi('unexpected'),
          DriverPerformanceDistributionCategory.unknown,
        );
        expect(
          DriverPerformanceDistributionCategory.fromApi(null),
          DriverPerformanceDistributionCategory.unknown,
        );
      },
    );
    ...
    test(
      'DriverPerformanceQueryEntity validates custom date range requirement and formatting',
      () {
        expect(
        ...
        const preset = DriverPerformanceQueryEntity(
    ...
    test(
      'Local sorting sorts records immutably without modifying original list',
      () {
        ...
        expect(
          sortedByNameAsc.first.driverId,
          'd2',
        ); // 'Amr' comes before 'Zaid'
      },
    );
