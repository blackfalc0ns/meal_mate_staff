...
void main() {
  group('DriverPerformance DTO and Mapper Tests', () {
    test('Overview complete json maps correctly to DriverPerformanceOverviewEntity', () {
      final json = {
        'period': 'Last7Days',
      ...
      expect(entity.distribution.segments.first.category, DriverPerformanceDistributionCategory.onTime);
      expect(entity.distribution.segments[1].category, DriverPerformanceDistributionCategory.late);
      expect(entity.topDrivers.length, 1);
      expect(entity.topDrivers.first.name, 'Ahmad');
      expect(entity.driversTable.first.delayLevel, DriverPerformanceDelayLevel.good);
      expect(entity.driversTable.first.status, DriverPerformanceDriverStatus.available);
    ...
    test('Overview empty and malformed json handles defensive fallbacks', () {
      ...
      expect(entity.driversTable.first.status, DriverPerformanceDriverStatus.unknown);
      expect(entity.driversTable.first.delayLevel, DriverPerformanceDelayLevel.unknown);
    ...
    test('Comparison complete json maps correctly to DriverPerformanceComparisonEntity', () {
      final json = {
        'period': 'ThisMonth',
      ...
      final entity = DriverPerformanceComparisonResponseDto.fromJson(json).toEntity();
    ...
    test('Comparison empty json handles null lists and null optional metrics', () {
      final json = <String, dynamic>{
        'drivers': null,
      };
