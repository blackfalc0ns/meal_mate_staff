...
void main() {
  group('Approved-Account Activation and Resubmission Flow Tests', () {
    test(
      'AccountStatusViewModel handles AccountStatusActivateApprovedEvent success',
      () async {
        ...
        expect(
          ...
          AccountStatusStateStatus.activationSuccess,
        );
    ...
    test(
      'AccountStatusViewModel handles AccountStatusActivateApprovedEvent returning password login',
      () async {
    ...
    test(
      'AccountStatusViewModel handles AccountStatusActivateApprovedEvent failure',
      () async {
    ...
    testWidgets(
      'Approved status screen triggers activation on primary button tap and navigates to OTP',
      (tester) async {
        final authRepo = _FakeAuthRepo()..isFirstTime = true;
        final statusRepo = _FakeStatusRepo();
    ...
    testWidgets(
      'NeedsChanges status screen navigates to register on primary button tap',
      (tester) async {
        final statusRepo = _FakeStatusRepo()
