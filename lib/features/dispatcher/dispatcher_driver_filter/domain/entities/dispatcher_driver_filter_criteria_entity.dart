class DispatcherDriverFilterCriteriaEntity {
  const DispatcherDriverFilterCriteriaEntity({
    this.selectedArea,
    this.selectedStatus,
    this.minRating,
    this.distanceKm,
  ...
  factory DispatcherDriverFilterCriteriaEntity.initial() {
    return const DispatcherDriverFilterCriteriaEntity(
      selectedArea: null,
      selectedStatus: null,
      minRating: null,
      distanceKm: null,
  ...
  DispatcherDriverFilterCriteriaEntity copyWith({
    String? selectedArea,
    ...
    return DispatcherDriverFilterCriteriaEntity(
  ...
  bool operator ==(Object other) =>
      ...
      other is DispatcherDriverFilterCriteriaEntity &&
